...
while run:
    ...
    clue = open('clues.txt','r')
    n = file.readlines()
    m = clue.readlines()
    selected_word = n[index].strip('\n')
    selected_clue = m[index].strip('\n')
    ...
    s1.place(x = 10,y = 10)
    text = Label(root, text=selected_clue, bg="#E7FFFF", font=("arial", 25))
    text.place(relx=0.5, rely=0.62, anchor=CENTER)
